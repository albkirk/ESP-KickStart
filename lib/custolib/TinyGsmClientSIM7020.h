...
class TinyGsmSim7020 : public TinyGsmModem<TinyGsmSim7020>,
                       ...
                       public TinyGsmGPS<TinyGsmSim7020>,
  ...
  friend class TinyGsmGPS<TinyGsmSim7020>;
 ...
 public:
  ...
  public:
    ...
    GsmClientSecure(TinyGsmSim7020& modem, uint8_t mux = 0)
 ...
 protected:
  ...
  // During sleep, the SIM7020 module has its serial communication disabled.
  // In order to reestablish communication pull the DRT-pin of the SIM7020
